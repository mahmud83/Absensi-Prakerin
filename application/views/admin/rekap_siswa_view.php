					...
					<div class="box-header">
						<div class="row">
							<div class="col-lg-6 col-md-12 col-sm-12">
								<center style="padding: 8px;"><h3 class="box-title" style="font-weight: 600;">Daftar Ketidakhadiran Siswa Bulan <?php echo date("M Y"); ?></h3></center>
						...
						<div id="chartperbulan" class="col-lg-6 col-sm-12">
							<script type="text/javascript">
								...
								Highcharts.chart('chartperbulan', {
									...
									title: {
										text: 'Jumlah Keterangan Siswa (<?php echo date("M Y") ?>)'
									},
									xAxis: {
