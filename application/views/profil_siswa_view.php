            ...
            <div class="panel panel-green">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <!-- <div class="col-lg-3">
                          <div class="container">
                            <img src="<?php echo base_url();?>uploads/foto_siswa/<?php echo $foto; ?>" alt="Avatar" class="anu img-thumbnail">
                            <div class="middle">
                              <form id="formfoto" action="<?php echo base_url(); ?>index.php/siswa/updatefoto/<?php echo $id_sw = $this->session->userdata('id_user'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <label style="background-color: rgba(0,0,0,.3); color: white; padding: 5px;">
                                  EDIT PHOTO
                                  <input type="file" id="foto" name="foto" class="change-avatar changephoto" onchange="this.form.submit()">
                                </label>
                              </div>
                              </form>
                            </div>
